...
const destinations = [
  {
    ...
    description: "A sacred city attracting millions of pilgrims every year.",
    tags: ["Religious", "Family", "Weekend"],
  },
  {
    name: "Varanasi",
    image: "/images/destinations/varanasi.png",
    description: "Experience spirituality, culture and the famous ghats.",
  ...
  {
    name: "Kanpur",
    image: "/images/destinations/kanpur.png",
    description: "Perfect for business meetings, shopping and education.",
    tags: ["Business", "Students", "Daily Travel"],
  },
  {
    name: "Naimisharanya",
    image: "/images/destinations/naimish.png",
    description: "One of Uttar Pradesh's most sacred pilgrimage destinations.",
    tags: ["Religious", "Family"],
  },
  {
    name: "Chitrakoot",
    image: "/images/destinations/chitrakoot.png",
    description: "Known for spirituality and breathtaking natural beauty.",
    tags: ["Pilgrimage", "Sightseeing"],
  },
  {
    name: "Agra",
    image: "/images/destinations/agra.png",
    description: "Visit the Taj Mahal and enjoy a memorable road trip.",
    tags: ["Weekend", "Tourism", "Family"],
  },
  {
    name: "Delhi",
    image: "/images/destinations/delhi.png",
    description: "Business travel, airport transfers and leisure trips.",
    tags: ["Business", "Airport", "Personal"],
  },
  {
    name: "Jaipur",
    image: "/images/destinations/jaipur.png",
    description: "Discover forts, palaces and Rajasthan's rich culture.",
    tags: ["Vacation", "Family", "Couples"],
  },
  {
    name: "Nainital",
    image: "/images/destinations/nainital.png",
    description: "Escape into the hills for a peaceful holiday.",
    tags: ["Hill Station", "Family", "Honeymoon"],
  },
  {
    name: "Mussoorie",
    image: "/images/destinations/mussoorie.png",
    description: "One of India's most loved hill stations.",
    tags: ["Holiday", "Nature", "Couples"],
  },
  {
    name: "Jim Corbett",
    image: "/images/destinations/jim corbett.png",
    description: "Perfect destination for wildlife lovers and weekend trips.",
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-6 text-4xl font-black text-slate-900 lg:text-5xl">
            ...
            <span className="block text-blue-700">Journey Take You?</span>
          </h2>

          <p className="mt-6 text-lg leading-8 text-slate-600">
            Travel comfortably from Lucknow to popular destinations across Uttar
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          {destinations.map((place) => (
            ...
            >
              ...
              <div className="p-7">
                <p className="leading-7 text-slate-600">{place.description}</p>
        ...
        <div className="mt-20 rounded-3xl bg-gradient-to-r from-blue-900 via-blue-700 to-blue-600 p-10 text-center text-white">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-blue-100">
            We provide outstation cab services to hundreds of cities across
            Uttar Pradesh, Uttarakhand, Rajasthan, Delhi NCR and neighbouring
            states. Contact us and we'll plan your perfect journey.
          </p>
