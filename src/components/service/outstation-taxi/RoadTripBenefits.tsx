      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-6 text-4xl font-black text-slate-900 lg:text-5xl">
            Why Road Trips Are
            <span className="block text-blue-700">More Enjoyable With Us</span>
          </h2>

          <p className="mt-6 text-lg leading-8 text-slate-600">
            A private outstation cab gives you complete flexibility, comfort and
            freedom to enjoy every kilometre of your journey.
          </p>
        </div>
