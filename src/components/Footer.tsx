      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-6 leading-8 text-gray-400">
              Reliable taxi services in Lucknow offering airport transfers,
              local cab booking, outstation travel, tour packages, tempo
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="text-center">
            <h3 className="mb-3 text-lg font-semibold">We Accept</h3>
          ...
          <div className="text-center lg:text-right">
            <h3 className="mb-3 text-lg font-semibold">Why Choose Us</h3>
