...
import { Send, MessageCircle, PhoneCall, Sparkles } from "lucide-react";
...
• Journey Details: ${formData.details}`;
  ...
  return (
    <section className="bg-slate-50 py-16 sm:py-20" id="get-quote-form">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 sm:p-10 md:p-12">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="mt-3 text-xs sm:text-sm text-slate-600 max-w-xl mx-auto">
              Fill in your journey requirements below to receive the best transparent
              pricing directly on WhatsApp or phone.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="details" className="block text-xs font-bold text-slate-800">
                Journey Route & Vehicle Preference <span className="text-red-500">*</span>
              </label>
              <textarea
                id="details"
                name="details"
                ...
                placeholder="e.g. Lucknow to Ayodhya Roundtrip for 6 passengers, need Ertiga or Innova..."
              />
            </div>
