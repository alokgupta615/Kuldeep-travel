...
const destinations = [
  {
    ...
    distance: "135 km",
    description:
      "Visit Shri Ram Janmabhoomi, Hanuman Garhi, and Saryu Ghat with comfortable taxi service.",
    href: "/book-now",
  },
  {
    name: "Varanasi",
    ...
    distance: "320 km",
    description: "Travel to Kashi Vishwanath, Ganga Aarti, and Ghats with reliable rides.",
    href: "/book-now",
  },
  {
    name: "Prayagraj",
    ...
    distance: "205 km",
    description:
      "Convenient trips to Triveni Sangam, Anand Bhavan, and sacred pilgrimage points.",
    href: "/book-now",
  },
  {
    name: "Agra / Taj Mahal",
    ...
    distance: "335 km",
    description: "Explore the Taj Mahal & Agra Fort with expressway non-stop taxi service.",
    href: "/book-now",
  },
  {
    name: "Nainital",
    ...
    distance: "420 km",
    description: "Scenic hill holiday package with Naini Lake boating and Himalayan views.",
    href: "/book-now",
  },
  {
    name: "Naimisharanya",
    ...
    distance: "90 km",
    description: "Sacred pilgrimage tour to Chakra Tirtha, Lalita Devi & Vyas Gaddi.",
    href: "/book-now",
  },
  {
    name: "Chitrakoot",
    ...
    distance: "230 km",
    description: "Visit Kamadgiri, Ramghat, Gupt Godavari & Sphatik Shila spiritual sites.",
    href: "/book-now",
  },
  {
    name: "Kanpur",
    ...
    distance: "85 km",
    description: "Quick corporate, shopping, and family one-way and round-trip transfers.",
    href: "/book-now",
  },
  {
    name: "Mathura",
    ...
    distance: "470 km",
    description: "Shri Krishna Janmabhoomi & Vrindavan holy temple packages.",
    href: "/book-now",
  },
  {
  ...
  },
  {
    ...
    distance: "550 km",
    description: "Comfortable long-distance expressway travel with experienced highway drivers.",
    href: "/book-now",
  },
];
