...
export default function Hero() {
  return (
    <section className="relative min-h-[calc(100svh-72px)] overflow-hidden bg-gradient-to-br from-blue-950 via-blue-900 to-blue-700">
      {/* Background Effects */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-40 -top-40 h-80 w-80 rounded-full bg-yellow-400/15 blur-3xl sm:h-96 sm:w-96" />

        <div className="absolute -bottom-40 -right-40 h-80 w-80 rounded-full bg-cyan-400/15 blur-3xl sm:h-96 sm:w-96" />
      </div>

      <div className="relative mx-auto flex min-h-[calc(100svh-72px)] max-w-7xl items-center px-4 sm:px-6 lg:px-8">
        <div className="grid w-full items-center gap-7 py-8 sm:gap-10 sm:py-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10 lg:py-8 xl:gap-14">
          {/* ================= LEFT CONTENT ================= */}
          <div className="text-center lg:text-left">
            {/* Badge */}
            <div className="inline-flex items-center rounded-full border border-yellow-400/20 bg-yellow-400/10 px-3.5 py-1.5 text-xs font-semibold text-yellow-300 sm:px-4 sm:py-2 sm:text-sm">
              <Sparkles className="mr-1.5 h-3.5 w-3.5 sm:mr-2 sm:h-4 sm:w-4" />
              Premium Holiday Packages
            </div>

            {/* Heading */}
            <h1 className="mx-auto mt-4 max-w-3xl text-3xl font-black leading-[1.08] tracking-tight text-white sm:mt-5 sm:text-4xl md:text-5xl lg:mx-0 lg:text-[3.4rem] xl:text-[4rem]">
              Lucknow
              <span className="block text-yellow-400">Holiday Packages</span>
              <span className="block">for Comfortable Trips</span>
            </h1>
            ...
            {/* Description */}
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-6 text-blue-100 sm:mt-5 sm:text-base sm:leading-7 lg:mx-0 lg:max-w-xl">
              Planning your next vacation? Discover thoughtfully designed
              holiday packages for families, couples, groups and spiritual
              travellers. From transportation to sightseeing and itinerary
              planning, Kuldeep Travels ensures every journey is comfortable,
            ...
            {/* Buttons */}
            <div className="mt-5 flex flex-col gap-3 sm:mt-6 sm:flex-row sm:justify-center lg:justify-start">
              <Link
                href="/book-now"
                className="inline-flex h-12 items-center justify-center rounded-xl bg-yellow-400 px-7 text-sm font-bold text-blue-950 transition hover:scale-[1.02] hover:bg-yellow-300 sm:h-13 sm:text-base"
              >
                Book Holiday
              ...
              <Link
                href="/contact"
                className="inline-flex h-12 items-center justify-center rounded-xl border border-white/20 bg-white/10 px-7 text-sm font-semibold text-white backdrop-blur transition hover:bg-white/20 sm:h-13 sm:text-base"
              >
                Get Free Quote
              </Link>
            </div>
            ...
            {/* Features */}
            <div className="mx-auto mt-6 grid max-w-2xl grid-cols-2 gap-2.5 sm:mt-7 sm:gap-3 lg:mx-0">
              {features.map((item) => (
                <div
                  key={item}
                  className="flex min-h-[42px] items-center rounded-lg border border-white/10 bg-white/[0.08] px-3 py-2 backdrop-blur-sm sm:min-h-[46px] sm:rounded-xl sm:px-3.5"
                >
                  <CheckCircle2 className="mr-2 h-4 w-4 shrink-0 text-yellow-400 sm:h-[18px] sm:w-[18px]" />

                  <span className="text-left text-[11px] font-medium leading-tight text-white sm:text-xs lg:text-sm">
                    {item}
                  </span>
                </div>
              ))}
