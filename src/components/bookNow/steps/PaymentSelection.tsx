...
//     badge: "Most Popular",
//     color: "yellow",
//     description: "Pay the driver when your journey begins.",
//     benefits: [
//       "No advance payment",
//       "UPI / Cash / Card",
...
//     badge: "",
//     color: "blue",
//     description: "Pay after safely reaching your destination.",
//     benefits: [
//       "Cash or UPI",
...
//     benefits: ["UPI", "Credit/Debit Card", "Net Banking"],
//   },
// ];
...
export default function PaymentSelection({ formData, setFormData }: Props) {
  return (
    <div>
      {/* Heading */}
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        {paymentMethods.map((payment) => {
          const selected = formData.payment === payment.id;
          ...
          return (
            ...
            >
              ...
              <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-50">
                <payment.icon size={34} className="text-blue-700" />
              </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-3 leading-7 text-slate-700">
              Kuldeep Travels follows a transparent pricing policy. You'll
              receive your booking confirmation immediately after submission.
              Online payments are securely processed through Razorpay, while
              Cash, UPI, and Cards are accepted for offline payments.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-3">
        <div className="rounded-2xl border bg-white p-6 text-center">
          <ShieldCheck className="mx-auto text-green-600" size={34} />

          <h4 className="mt-4 font-bold">Secure Booking</h4>
        </div>

        <div className="rounded-2xl border bg-white p-6 text-center">
          <BadgeIndianRupee className="mx-auto text-yellow-500" size={34} />

          <h4 className="mt-4 font-bold">No Hidden Charges</h4>
        </div>

        <div className="rounded-2xl border bg-white p-6 text-center">
          <Sparkles className="mx-auto text-blue-700" size={34} />

          <h4 className="mt-4 font-bold">Instant Confirmation</h4>
        </div>
      </div>
    </div>
  );
